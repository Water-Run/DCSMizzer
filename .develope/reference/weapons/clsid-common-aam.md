# Weapons CLSID reference (extract)

Source: `pydcs/dcs/weapons_data.py` (generated from DCS export).

Full dump: [`../data/weapons-index.json`](../data/weapons-index.json) (2024 entries).
...
## Common air-to-air missiles (curated)

| attr | clsid | name | weight |
|------|-------|------|--------|
| `AB_250_2___17_x_SD_10A__250kg_CBU_with_10kg_Frag_HE_submunitions` | `{AB_250_2_SD_10A}` | AB 250-2 - 17 x SD-10A, 250kg CBU with 10kg Frag/HE submunitions | 220 |
| `AB_500_1___34_x_SD_10A__500kg_CBU_with_10kg_Frag_HE_submunitions` | `{AB_500_1_SD_10A}` | AB 500-1 - 34 x SD-10A, 500kg CBU with 10kg Frag/HE submunitions | 470 |
...
| `Matra_Type_155_Rocket_Pod` | `{Matra155RocketPod}` | Matra Type 155 Rocket Pod | 190 |
...
## MiG-29 / Su-27 era AA sample CLSIDs
