...
KNOWN_REPORT_SCHEMAS = frozenset(
    {
        ...
        "dcsmizzer.construction-bundle/v1",
        "dcsmizzer.construction-snapshot/v1",
        "dcsmizzer.construction-verification/v1",
        ...
        "dcsmizzer.evidence-bundle/v1",
        "dcsmizzer.evidence-bundle-verification/v1",
        "dcsmizzer.evidence-diff/v1",
